...
### What I do
- **Full-stack product development** — React, Next.js, TypeScript on the frontend; Python, FastAPI, PostgreSQL on the backend. I own features from schema to shipped UI, not just one layer.
- **Frontend architecture** — Design systems aligned with Figma tokens, component libraries, performance optimisation against Core Web Vitals.
- **Headless commerce** — Shopify Hydrogen, Storefront API, headless storefronts on Next.js. Headless CMS work across Contentful, Sanity, and Strapi.
- **Messaging & lifecycle infrastructure** — WhatsApp Business Platform (bots wired directly into backend services), Klaviyo flows and campaigns, transactional/marketing email in MJML.
- **Production ownership** — deployment on Hetzner Cloud, Vercel, AWS; Docker, Nginx, CI/CD. I ship code and own it through to production, not just hand it off.
- **AI-assisted workflows** — Cursor, Claude, GitHub Copilot integrated into my daily flow, plus hands-on LLM integration (Gemini) shipped into two production products. On recent client work AI-assisted workflows have cut Figma-to-shipped-component time by ~35%.
...
Frontend     React, Next.js, Redux, React Native, Tailwind
Backend      FastAPI, Node.js, REST APIs, GraphQL, Web Sockets
Data/Infra   PostgreSQL, Redis, RabbitMQ
Commerce     Shopify Hydrogen, Storefront API, headless commerce, Razorpay
Integrations WhatsApp Business API, Terra API, Gemini/LLM, Klaviyo, MJML
CMS          Contentful, Sanity, Strapi
Cloud        Hetzner, AWS, Azure, Vercel, Docker, Nginx
Tooling      Git, CI/CD (Jenkins, GitHub Actions), Figma, Cursor, Claude
```

---

### Currently
Founder & full-stack engineer at **Wishkr**, full-time. Alongside that, open to select **freelance/contract** engagements (full-stack, headless commerce, lifecycle-marketing engineering) and **full-time full-stack roles relocating to Helsinki, Finland**.
IST, with strong EU and partial US overlap.
